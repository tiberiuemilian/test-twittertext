...
public class UtilsTest extends TestCase {
    ...
    public void testCharacterCount() {
        assertEquals("Challenge test", 65, Utils.getCount("Former UNM law professor named FERC chair http://bit.ly/1IifCDF"));
        ...
        assertEquals("URLs should be counted without transformation", 86, Utils.getCount("Text with url: " +
                                                                                "a.com http://abc.com https://longurllongurllongurl.com"));
        assertEquals("t.co URLs should be counted without transformation", 62, Utils.getCount("Text with t.co url: https://t.co/foobar"));
    }
}
